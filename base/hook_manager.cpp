...
void hook_manager_t::init()
{
	...
	printf(XOR_STR("debug ~ started hook_mgr\n"));
	...
	//			&hooks::recv_proxies::layer_sequence);
	create_hook(layer_cycle, game->client.at(sdk::props::animationlayer::cycle),
				&hooks::recv_proxies::layer_cycle);
	create_hook(layer_playback_rate,
				game->client.at(sdk::props::animationlayer::playback_rate),
				&hooks::recv_proxies::layer_playback_rate);
	create_hook(layer_weight, game->client.at(sdk::props::animationlayer::weight),
				&hooks::recv_proxies::layer_weight);
	create_hook(layer_weight_delta_rate,
				game->client.at(sdk::props::animationlayer::weight_delta_rate),
				&hooks::recv_proxies::layer_weight_delta_rate);
	create_hook(layer_order, game->client.at(sdk::props::animationlayer::order),
				&hooks::recv_proxies::layer_order);
	create_hook(general, game->client.at(sdk::props::animationlayer::prev_cycle),
				&hooks::recv_proxies::general);
	create_hook(general_int, game->client.at(sdk::props::base_entity::model_index),
				&hooks::recv_proxies::general_int);
	create_hook(general_vec, game->client.at(sdk::props::local::aim_punch_angle),
	...
	create_hook(int_to_ehandle,
				game->client.at(sdk::props::base_player::ground_entity),
				&hooks::recv_proxies::int_to_ehandle);
	create_hook(weapon_handle, game->client.at(sdk::props::base_view_model::weapon),
				&hooks::recv_proxies::weapon_handle);
	create_hook(viewmodel_sequence,
				game->client.at(sdk::props::base_view_model::sequence),
				&hooks::recv_proxies::viewmodel_sequence);
	create_hook(simulation_time,
				game->client.at(sdk::props::base_entity::simulation_time),
				&hooks::recv_proxies::simulation_time);
	create_hook(effects, game->client.at(sdk::props::base_weapon_world_model::effects),
	...
	create_hook(host_shutdown, game->engine.at(sdk::functions::host_shutdown), &hooks::miscellaneous::host_shutdown);
	create_hook(hud_draw_scope, game->client.at(0x4BDBB0), &hooks::miscellaneous::hud_draw_scope);
	create_hook(particle_draw_model, game->client.at(sdk::functions::particle_draw_model),
				&hooks::miscellaneous::particle_draw_model);
	create_hook(ent_info_list_link_before, game->client.at(sdk::functions::ent_info_list_link_before),
				&hooks::miscellaneous::ent_info_list_link_before);
	create_hook(process_input, game->client.at(sdk::functions::process_input), &hooks::miscellaneous::process_input);
	create_hook(start_sound_immediate, game->engine.at(sdk::functions::start_sound_immediate),
				&hooks::miscellaneous::start_sound_immediate);
	create_hook(check_param, game->tier0.at(0x2E50), &hooks::miscellaneous::check_param);
	create_hook(move_helper_start_sound, game->client.at(sdk::functions::move_helper_start_sound),
				&hooks::miscellaneous::move_helper_start_sound);
	create_hook(get_tonemap_settings_from_env_tonemap_controller,
				game->client.at(sdk::functions::get_tonemap_settings_from_env_tonemap_controller),
				&hooks::miscellaneous::get_tonemap_settings_from_env_tonemap_controller);
	create_hook(draw_mesh, game->shaderapidx9.at(sdk::functions::draw_mesh), &hooks::miscellaneous::draw_mesh);
	/*create_hook(draw_3d_debug_overlays, game->engine.at(sdk::functions::draw_3d_debug_overlays),
				&hooks::miscellaneous::draw_3d_debug_overlays);*/
	create_hook(render_glow_boxes, game->client.at(sdk::functions::render_glow_boxes),
				&hooks::miscellaneous::render_glow_boxes);
	create_hook(spawn_smoke_effect, game->client.at(sdk::functions::spawn_smoke_effect),
				&hooks::miscellaneous::spawn_smoke_effect);
	create_hook(render_iron_sight_scope_effect, game->client.at(sdk::functions::render_iron_sight_scope_effect),
				&hooks::miscellaneous::render_iron_sight_scope_effect);
	create_hook(convar_network_change_callback, game->engine.at(sdk::functions::convar_network_change_callback),
				&hooks::miscellaneous::convar_network_change_callback);
	create_hook(tefirebullets_post_data_update, game->client.at(sdk::functions::tefirebullets_post_data_update),
				&hooks::miscellaneous::tefirebullets_post_data_update);
	create_hook(enforce_competitive_cvar, game->client.at(sdk::functions::enforce_competitive_cvar),
