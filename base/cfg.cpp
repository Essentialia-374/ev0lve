...
void cfg_t::init()
{
	...
	ADD(rage.weapon_cfgs[grp_general].min_dmg_override);
	...
	ADD(rage.weapon_cfgs[grp_pistol].min_dmg_override);
	...
	ADD(rage.weapon_cfgs[grp_heavypistol].min_dmg_override);
	...
	ADD(rage.weapon_cfgs[grp_automatic].min_dmg_override);
	...
	ADD(rage.weapon_cfgs[grp_awp].min_dmg_override);
	...
	ADD(rage.weapon_cfgs[grp_scout].min_dmg_override);
	...
	ADD(rage.weapon_cfgs[grp_autosniper].min_dmg_override);
