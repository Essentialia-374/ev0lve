...
#define MAKE_TAB(i, n)                                                                                                 \
	std::make_shared<tab>(evo::gui::control_id{evo::gui::hash(i), i}, XOR(n), evo::gui::hash(i "_container"),                      \
						  draw.textures[evo::gui::hash("icon_" i)])
#define MAKE(h, t, ...) std::make_shared<t>(evo::gui::control_id{evo::gui::hash(h), h}, __VA_ARGS__)
...
#define ADD_INLINE(l, ...)                                                                                             \
	e->add(make_inlined(evo::gui::hash(l "_content"),                                                                        \
